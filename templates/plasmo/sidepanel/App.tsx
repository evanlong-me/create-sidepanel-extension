        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Plasmo + Tailwind CSS 4.0 + shadcn/ui
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="space-y-4 p-4">
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    A modern browser extension template built with Plasmo,
                    Tailwind CSS 4.0, and shadcn/ui components.
                  </p>
                  <div className="grid gap-4">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Built with Plasmo, React, TypeScript, and Tailwind CSS
              ...
              <div className="space-y-6 p-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-4">
                      Values from lib/config.ts (read-only)
                    </p>
                  </div>
